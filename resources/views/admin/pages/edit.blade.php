    ...
    <div class="container ">
        ...
        <form method="POST" action="{{ route('admin.apartments.update', $apartment->id) }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="number" min="1" max="50" value="{{ $apartment->bathrooms }}"
            ...
            <div class="mb-4">
                ...
                <input type="number" min="1" max="50" value="{{ $apartment->accomodation }}"
            ...
            @foreach ($services as $service)
                <div class="cat action btn btn-outline-dark p-0 mr-2">
                    <label>
