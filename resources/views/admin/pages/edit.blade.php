...
<body class="m-0 p-0">
    ...
    <div class="">
      ...
      {{-- MAPPA  --}}
        ...
        <form class="d-flex flex-column w-50 ps-5 m-auto h-100" method="POST" action="{{ route('admin.apartments.update', $apartment->id) }}" enctype="multipart/form-data">
      ...
      <div class="d-flex">
          ...
          <div class="mb-4 w-25 ms-5">
              ...
              <input type="number" min="1" max="50" class="form-control" name="bathrooms" value="{{$apartment->bathrooms}}" required >
              @error('bathrooms')
                  <div class="alert alert-danger">{{ $message }}</div>
              @enderror
          </div>
          ...
          <div class="mb-4 w-25 ms-5">
              ...
              <input type="number" min="1" max="1000" class="form-control" name="mq" value="{{$apartment->mq}}" required >
              @error('mq')
                  <div class="alert alert-danger">{{ $message }}</div>
              @enderror
          </div>
      ...
      <div class="d-flex">
          ...
          <div class="mb-4 w-25 ms-5">
              ...
              <input type="number" min="1" max="50" class="form-control" name="accomodation" value="{{$apartment->accomodation}}" required >
              @error('accomodation')
                  <div class="alert alert-danger">{{ $message }}</div>
              @enderror
          </div>
          ...
          <div class="">
              ...
              <input type="text" class="form-control border-0 position-absolute" style="top: 120px; left: -1000px; opacity: 0.0;" name="address" id="address" value="{{$apartment->address}}" required >
              @error('address')
                  <div class="alert alert-danger">{{ $message }}</div>
              @enderror
          </div>
      ...
      <div class="d-flex  justify-content-between">
                  ...
                  <div class="cat action btn btn-dark border-0 rounded-5 p-1 mr-1 mb-2 ">
                      <label class="">
                          <input type="checkbox" name="services[]"
                              value="{{ $service->id }}" {{ $apartment->services->contains($service) ? 'checked' : '' }}><span>{{ $service->name }}</span>
                      </label>
                  </div>
              @endforeach
          </div>
          ...
          <input type="hidden" name="lat" type="text" id="lat" value="{{$apartment->lat}}"> </input>
          <input type="hidden" name="long" type="text" id="long" value="{{$apartment->long}}"> </input>

          {{-- INVIO --}}
          <div class="w-25 mt-5">
              <button type="submit" class=" btn-custom ">Edit apartment</button>
          </div>
